...
const mapStateToProps = state => {
  ...
  const wtfValue = selectorLogin(state, 'wtf');
   return {
    skillsValue, notesValue, artValue, sportValue, justPlayValue, femaleValue, guitarValue, wtfValue
  };
};
// eslint-disable-next-line react/prefer-stateless-function
class CapabilitiesForm extends Component {
  render() {
    const { handleSubmit, skillsValue, notesValue, artValue, sportValue, justPlayValue, femaleValue, guitarValue, wtfValue} = this.props;
    const submitData =()=>{
      alert (`${skillsValue  }  ${ notesValue}  ${artValue} ${sportValue} ${justPlayValue} ${femaleValue} ${guitarValue} ${wtfValue}` );
    };
        ...
        <div className={styles.CapabilitiesForm}>
          <div className={styles.first}>
            ...
            <div className={styles.textArea}>
              <Field name="notes" component="textarea" className={styles.textArea}  />
            </div>
          </div>
          <div className={styles.second}>
            ...
            <label className={styles.container}>
              <Field component="input" type="checkbox" name="sport" value="Sport, fitness, aerobica and staff like that" />
              <span className={styles.checkmark} />
              Sport, fitness, aerobica and staff like that
            </label>

            <label className={styles.container}>
              <Field component="input" type="checkbox" name="justPlay" value="I just want to play games, I’m not living in this life" />
              <span className={styles.checkmark} />
              I just want to play games, I’m not living in this life
            </label>

            <label className={styles.container}>
              <Field component="input" type="checkbox" name="female" value="I’m a female... I’m doing nothing. Every day." />
              <span className={styles.checkmark} />
              I’m a female... I’m doing nothing. Every day.
            </label>

            <label className={styles.container}>
              <Field component="input" type="checkbox" name="guitar" value="Guitar, guitar and guitar again. I’m fall in love with it." />
              <span className={styles.checkmark} />
              Guitar, guitar and guitar again. I’m fall in love with it.
            </label>

            <label className={styles.container}>
              <Field component="input" type="checkbox" name="wtf" value="WTF is “hobbies”???" />
              <span className={styles.checkmark} />
              WTF is “hobbies”???
            </label>
          ...
          Back
              ...
              <button type="submit" className={styles.btnCapabilities} onClick={submitData}>
          Finish
              </button>
            </div>
          </div>
